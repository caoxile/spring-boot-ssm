...
public class CodeGenerator {
    ...
    private static final String JDBC_USERNAME = "username";//数据库用户名
    ...
    private static final String MODEL_PACKAGE = BASE_PACKAGE + ".model";//生成的Model所在包
    ...
    private static final String CONTROLLER_PACKAGE = BASE_PACKAGE + ".web";//生成的Controller所在包
